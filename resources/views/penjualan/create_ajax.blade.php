...
$(document).ready(function(){
    ...
    function addDetailRow(){
        ...
        $.each(barangs, function(i, barang){
            row += `<option value="${barang.barang_id}" data-harga="${barang.harga_jual}" data-stok="${barang.get_stok}">
                        ${barang.barang_nama} (Rp. ${Number(barang.harga_jual).toLocaleString()}, Stok: ${barang.get_stok})
                    </option>`;
        });
        row += `</select>
